...
namespace NCMB
{
    ...
    public class NCMBManager : MonoBehaviour 
    {
        ...
        #region Delegate
        /// <summary> 端末登録成功。</summary>
        public delegate void OnRegistrationSucceededDelegate();
        /// <summary> 端末登録失敗。</summary>
        public delegate void OnRegistrationFailedDelegate(string errorMessage);
        /// <summary> メッセージ受信。</summary>
        public delegate void OnNotificationReceivedDelegate(NCMBPushPayload payload);
        /// <summary> プッシュ送信成功。</summary>
        public delegate void OnSendPushSucceededDelegate();
        /// <summary> プッシュ送信失敗。</summary>
        public delegate void OnSendPushFailedDelegate(string errorMessage);
        ...
        /// 端末登録成功。
        /// </summary>
        public static OnRegistrationSucceededDelegate onRegistrationSucceeded;

        /// <summary>
        /// 端末登録失敗。
        /// </summary>
        public static OnRegistrationFailedDelegate onRegistrationFailed;
        ...
        /// プッシュ送信成功。
        /// </summary>
        public static OnSendPushSucceededDelegate onSendPushSucceeded;

        /// <summary>
        /// プッシュ送信失敗。
        /// </summary>
        public static OnSendPushFailedDelegate onSendPushFailed;
        ...
        void OnRegistrationSucceeded(string message)
        {
            Inited = true;

            if (onRegistrationSucceeded != null)
            {
        ...
        void OnSendPushSucceeded(string message)
        {
            if (onSendPushSucceeded != null)
            {
                onSendPushSucceeded();
            }
        }

        void OnSendPushFailed(string message)
        {
            if (onSendPushFailed != null)
            {
                onSendPushFailed(message);
            }
        }
        /*
